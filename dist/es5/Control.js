...
var UIDReset = function (_a) {
  var children = _a.children,
    _b = _a.prefix,
    prefix = _b === void 0 ? '' : _b;
  var valueSource = (0, react_1.useState)(function () {
    return (0, context_1.createSource)(prefix);
  })[0];
...
var UIDFork = function (_a) {
  ...
  var valueSource = (0, react_1.useState)(function () {
    return (0, context_1.createSource)(id + '-' + prefix);
  })[0];
  return React.createElement(context_1.source.Provider, { value: valueSource }, children);
};
...
var UIDConsumer = function (_a) {
  ...
  return React.createElement(context_1.source.Consumer, null, function (value) {
    return React.createElement(UIDComponent_1.UID, { name: name, idSource: value, children: children });
  });
};
